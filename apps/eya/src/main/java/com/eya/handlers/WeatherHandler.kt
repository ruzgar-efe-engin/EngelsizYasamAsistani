        ...
        scope.launch {
            try {
                ...
                if (weatherData != null) {
                    ...
                    val finalText = if (naturalized != null && cityName.isNotEmpty()) {
                        if (language == "tr") {
                            "$cityName${if (districtName.isNotEmpty()) " $districtName" else ""} için $naturalized"
                        } else {
                            "$naturalized for $cityName${if (districtName.isNotEmpty()) ", $districtName" else ""}"
                        }
                    } else {
                        naturalized ?: weatherData
                    }

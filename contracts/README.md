...
- `0` - MAIN_ROTATE: Ana menü encoder döndü
- `1` - SUB_ROTATE: Alt menü encoder döndü
- `2` - CONFIRM: Seçim onaylandı (YES butonu veya SubSW)
- `3` - CANCEL: İptal (NO butonu)
- `4` - AI_PRESS: AI butonu basıldı
- `5` - AI_RELEASE: AI butonu bırakıldı
